...
namespace EazzyRents.Infrastructure.Migrations
{
    ...
    [Migration("20240418093635_RemovedOwnerIdInRatings")]
    partial class RemovedOwnerIdInRatings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fab2f71f-ed26-40b0-8a10-b6457008126e",
                            Name = "Landlord",
                            NormalizedName = "LANDLORD"
                        },
                        new
                        {
                            Id = "250b0f82-7ac7-4467-8e0d-77883bb04790",
                            Name = "Tenant",
                            NormalizedName = "TENANT"
                        },
                        new
                        {
                            Id = "8c687c32-2046-485c-a4f8-839a6ad76f6b",
                            Name = "Guest",
            ...
            modelBuilder.Entity("EazzyRents.Core.Models.ChatMessage", b =>
                {
                    b.HasOne("EazzyRents.Core.Models.Conversation", "Conversation")
                        .WithMany("ChatMessages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EazzyRents.Core.Models.User", "Sender")
                        .WithMany()
